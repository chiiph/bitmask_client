...
class LeapNetworkCheckTest(BaseLeapTest):
    ...
    def test_parse_log_and_react(self):
        checker = checks.LeapNetworkChecker()
        to_call = Mock()
        log = ["leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 read UDPv4 [ECONNREFUSED]: Connection refused (code=111)"]
        err_matrix = [(checks.EVENT_CONNECT_REFUSED, (to_call, ))]
        checker.parse_log_and_react(log, err_matrix)
        self.assertTrue(to_call.called)

        log = ["2012-11-19 13:36:26,177 - leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 ERROR: Linux route delete command failed: external program exited",
               "2012-11-19 13:36:26,178 - leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 ERROR: Linux route delete command failed: external program exited",
               "2012-11-19 13:36:26,180 - leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 ERROR: Linux route delete command failed: external program exited",
               "2012-11-19 13:36:26,181 - leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 /sbin/ifconfig tun0 0.0.0.0",
               "2012-11-19 13:36:26,182 - leap.openvpn - INFO - Mon Nov 19 13:36:24 2012 Linux ip addr del failed: external program exited with error stat",
               "2012-11-19 13:36:26,183 - leap.openvpn - INFO - Mon Nov 19 13:36:26 2012 SIGTERM[hard,] received, process exiting", ]
        to_call.reset_mock()
        checker.parse_log_and_react(log, err_matrix)
