...
# This is a hack so that py2app copies _scrypt.so to the right place, it can't
# be technically imported, but that doesn't matter because the import is never
# executed
if False:
    import _scrypt
