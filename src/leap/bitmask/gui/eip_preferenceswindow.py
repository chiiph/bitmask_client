...
class EIPPreferencesWindow(QtGui.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.ui.clblAutoStartEIPStatus.setVisible(False)
        ...
        self.ui.clblAutoStartEIPStatus.clicked.connect(
            self.ui.clblAutoStartEIPStatus.hide)
    ...
    def _save_auto_start_eip(self):
        ...
        self.ui.clblAutoStartEIPStatus.show()
