...
class EIPBootstrapper(AbstractBootstrapper):
    ...
    def run_eip_setup_checks(self,
        ...
        d.addCallback(self._download_client_certificates)
        d.addErrback(self._errback, signal=self.download_client_certificate)
        d.addCallback(self._gui_notify, signal=self.download_client_certificate)
